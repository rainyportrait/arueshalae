...
describe("gallery pagination", () => {
    ...
    it("clamps a stale last-page value after fetching an empty page", async () => {
        ...
        const { collectionFor, ensurePage } = await import("../../src/state/gallery-collection.ts")
    ...
    it("updates the serialized origin pid when stepping onto another loaded page", async () => {
        ...
        const { step } = await import("../../src/state/gallery.ts")
        step(1)
    ...
    it("leaves modified arrows to the browser's history navigation", async () => {
        ...
        await import("../../src/state/gallery.ts")
...
describe("finding the active post after the origin page loads", () => {
    ...
    async function loadModules() {
        const collectionModule = await import("../../src/state/gallery-collection.ts")
        const { route } = await import("../../src/router.ts")
        const galleryModule = await import("../../src/state/gallery.ts")
